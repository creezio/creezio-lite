...
// Isolate the list-cell contract from unrelated dialogs/table hooks; keep the real Link and Badge.
...
registerHooks({resolve(spec,context,next){
 ...
 if(spec==='next/link')return next('next/link.js',context);
