...
export default {
  async email(message,env){
    ...
    const response=await fetch(url,{method:'POST',redirect:'error',headers:{'content-type':'application/json',Authorization:`Bearer ${env.EMAIL_INBOUND_SECRET}`},body:JSON.stringify(body)});
