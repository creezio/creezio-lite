...
13. Les correctifs communs sont proposés au responsable du kit par PR, avec reproduction, tests et lien vers l’application ; ne pas fusionner soi-même le kit. La veille s’exécute dans GitHub même si la tâche Codex est inactive. Activer GitHub Actions et Issues pour le dépôt, et adapter la branche `main` du workflow si la branche par défaut diffère.
