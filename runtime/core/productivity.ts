 ...
 */
type UsageFilters = {from?:string;to?:string;userId?:string;kind?:string};
...
export function getProductivityReport(rows:RawEvent[],filters:UsageFilters): ProductivityReport {
