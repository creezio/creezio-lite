...
export {
  ...
  LITE_ASAR_NPM_RUNTIME_PACKAGES,
  LITE_ASAR_RUNTIME_PACKAGES,
  LITE_ASAR_TOOLING_ONLY,
  LITE_ASAR_UNPACK_NATIVE,
  DEFAULT_HOST_ONLY_ELECTRON_MODULES,
  DEFAULT_WIN_BIN_STAGE,
  WIN_SERVER_BIN_FILTER,
  buildElectronBuilderConfig,
  collectLiteRuntimePackages,
...
export function resolveManifest(
  ...
  const appRoot = path.resolve(
    opts.appRoot || process.env.LITE_APP_ROOT || process.cwd(),
  );
  const candidates = [
