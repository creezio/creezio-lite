/**
 * Schéma AppManifest — identité d'une marque desktop Lite.
 *
...
export type AppManifest = {
   ...
   * `n8n-{slug}.…` selon `tunnelHostMode` / `LITE_TUNNEL_FLAT_HOSTS`).
   */
   ...
   * Override runtime : `LITE_TUNNEL_FLAT_HOSTS=1` (force flat).
   */
  ...
  domains: {
    ...
    primary: string;
    /** Domaine feed / infra Lite si distinct. */
    feedHost: string;
  };
 ...
 * Paramètre les scripts `@lite/desktop-tooling` sans hardcoder une marque.
 */
