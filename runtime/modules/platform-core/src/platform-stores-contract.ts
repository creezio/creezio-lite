...
export const PLATFORM_STORES_CONTRACT: readonly PlatformDomainContract[] = [
  {
    ...
    kitRole: "SoT credentials lite_users (+ sessions kit)",
  ...
  },
  {
    domain: "assistant",
    productBackend: "kit-core",
    kitRole: "SoT lite_assistant_* (model/mode/user_id/sources)",
  ...
  },
  {
    domain: "tasks",
    productBackend: "kit-core",
    kitRole: "SoT lite_platform_tasks (id partagé)",
  ...
  },
  {
    domain: "mails",
    productBackend: "kit-core",
    kitRole: "SoT index lite_platform_mails (inbound+outbound)",
