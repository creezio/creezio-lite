 ...
 * `_lite_schema_migrations` — pas de versioning partagé entre couches.
 */

import type { SqliteDatabase } from "./sqlite-driver.js";

/** Table de suivi des migrations (par fichier DB). */
export const SQLITE_MIGRATIONS_TABLE = "_lite_schema_migrations" as const;
...
export const SQLITE_META_MIGRATION: SqliteMigration = {
  ...
  sql: `
CREATE TABLE IF NOT EXISTS _lite_schema_info (
