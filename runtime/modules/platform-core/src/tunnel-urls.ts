 ...
 *
 * Pilotage (D2, mécanique unique) : env `LITE_CF_UNIVERSAL_SSL` truthy →
 * nested ; sinon (défaut) → flat. Un explicite `hostMode` (opts / config
 * persistée) prime toujours l'env. Remplace `LITE_TUNNEL_FLAT_HOSTS`
 ...
 */
export const TUNNEL_UNIVERSAL_SSL_ENV = "LITE_CF_UNIVERSAL_SSL";
 ...
 * - sinon env LITE_CF_UNIVERSAL_SSL=1|true → nested
