 ...
 *   CRM    : {slug}.{zone}  (ou LITE_DOMAIN — hostname complet custom)
 ...
 *
 * Mode de hostnames (D2) : `LITE_CF_UNIVERSAL_SSL` truthy → nested ;
 * sinon (défaut) → flat. Remplace `LITE_TUNNEL_FLAT_HOSTS` (supprimé —
 ...
 * `LITE_DOMAIN` / `LITE_TUNNEL_EXTRA_HOSTNAMES` sur l'instance
