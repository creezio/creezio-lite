...
import { getShellDesktopApi, getShellUiBrand } from "@lite/shell-ui";

/**
 * n8n — stack native Lite.
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Automatisations natives Lite. Les webhooks doivent utiliser
        ...
        <div>
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            ...
            <LockedConfigField
              ...
              hint="Sous le profil Lite (OS sandbox)."
            />
            <LockedConfigField
              label="Auth"
            ...
            <LockedConfigField
              ...
              hint="Géré par Lite — Hermes utilise aussi l’API key REST."
            />
            <LockedConfigField
              label="API key Hermes"
              value="Provisionnée silencieusement"
              hint="Fichier n8n-home/.lite-n8n-api-key.json — injectée dans Hermes."
            />
          </div>
        </div>
