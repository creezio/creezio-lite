/**
 * @lite/shell-ui/ui — primitives + shell CRM UI (O9, gold TF).
 * Consommer via `@lite/shell-ui/ui`.
 */
...
export type { ShellUiLoginBrand } from "../src/brand.js";
...
export {
  useLiteResource,
  useLiteResources,
  type UseLiteResourceOptions,
} from "./lib/use-lite-resource";
