 ...
 *
 * Vit dans `@lite/shell-ui/ui` pour que le chrome factory n'importe
 * pas `@lite/nav` au runtime UI. La factory **installe** quand même
 * `@lite/nav` (même vague publish) pour `/admin/nav` et le mount
 * auto-register. `@lite/nav/ui` re-exporte le même composant.
 *
