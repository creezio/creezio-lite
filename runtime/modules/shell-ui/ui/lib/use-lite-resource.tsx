 ...
 */
export function useLiteResource(
  resource: string,
  opts?: UseLiteResourceOptions,
): void {
...
export function useLiteResources(
  resources: string[],
  opts?: UseLiteResourceOptions,
): void {
