...
import { rankKeepAliveEvictionKeys } from "@lite/shell-ui";
...
export function KeepAliveOutlet({
  ...
  useEffect(() => {
    ...
    window.addEventListener("lite-keepalive-invalidate", onInvalidate);
    window.addEventListener("lite-keepalive-unfreeze", onInvalidate);
    return () => {
      window.removeEventListener("lite-keepalive-invalidate", onInvalidate);
      window.removeEventListener("lite-keepalive-unfreeze", onInvalidate);
    };
  }, []);
...
export function invalidateKeepAlive(href: string) {
  ...
  window.dispatchEvent(
    new CustomEvent("lite-keepalive-invalidate", { detail: href }),
  );
}
...
export function unfreezeKeepAlive(href: string) {
  if (typeof window === "undefined") return;
  window.dispatchEvent(
    new CustomEvent("lite-keepalive-unfreeze", { detail: href }),
  );
}
