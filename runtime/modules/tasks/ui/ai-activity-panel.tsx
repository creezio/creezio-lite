  ...
  return (
    <div className="flex flex-col">
      <div
        ...
        data-lite-tasks-ai-live-frames={frames}
      >
        {src ? (
...
export function AiActivityPanel({
  ...
  return (
    <aside
      ...
      data-lite-tasks-ai-activity={run?.id || ""}
    >
        ...
        {userId ? (
          <div className="flex gap-0.5 rounded-md border border-slate-200 p-0.5">
            ...
            <button
              ...
              data-lite-tasks-aid="ai-live-view-tab"
            >
        ...
        {logs.length === 0 ? (
          ...
          logs.map((l) => (
            <div
              ...
              data-lite-tasks-ai-log-seq={l.seq}
              data-lite-tasks-ai-log-type={l.event_type}
            >
              <span
                className={cn(
                  "mr-1.5 uppercase",
