...
import type { AssistantSource } from "../src/brand/sources-shim.js";
...
} from "../src/runtime/active-surface.js";
import type { AssistantMode } from "../src/runtime/modes.js";
...
function modeStorageKey(): string {
  try { return assistantIdentity().modeStorageKey; } catch { return "lite-assistant-preferred-mode"; }
}
function productNameLabel(): string {
  try { return assistantIdentity().productName; } catch { return "Lite"; }
}
function getDesktopApi(): any {
  ...
  try {
    ...
    return w[name] ?? w.liteDesktop;
  } catch {
    const w = window as any;
    return w.liteDesktop;
  }
}
