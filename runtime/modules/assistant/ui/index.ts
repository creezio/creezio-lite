 ...
 * Consommer via `@lite/assistant/ui`.
 */
export {
  AssistantProvider,
...
// doit l'importer d'ici, JAMAIS depuis la racine @lite/assistant qui tire
...
export {BrowserSessionProvider,BrowserWindowGate} from "./browser-session";
