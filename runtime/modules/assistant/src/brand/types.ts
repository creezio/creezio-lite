/**
 * Points d’extension marque pour `@lite/assistant` (Phase N3 / O4r).
 *
...
/** Résultat callTool MCP (aligné `@lite/mcp-facade`). */
...
export type AssistantBrandIdentity = {
  ...
  /** window.*Desktop API name (ex. liteDesktop / marqueDesktop). */
