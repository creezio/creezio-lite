...
import type { SqliteMigration } from "@lite/platform-core";
import type { DemoScenario, DemoScenarioOverride } from "./types.js";
import { validateDemoScenario } from "./types.js";

/* ------------------------------------------------------------- migrations */

export const INTERACTIVE_DEMO_SCHEMA_SQL = `-- Scénarios démo interactive hybride + preferences (@lite/interactive-demo)
