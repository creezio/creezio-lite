/**
 * Scénario de base générique — visite du socle OS Lite (sidebar,
 ...
 * Lite : Tâches, Mails, Assistant IA, Préférences pour tous les rôles ;
...
export function osFeatureChapters(
  ...
  const steps: DemoStep[] = [
    ...
    ),
    {
      ...
      kind: "highlight",
      target: { selector: "[data-lite-assistant-ui]" },
      title: "Assistant IA",
