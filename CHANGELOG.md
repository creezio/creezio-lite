...
- `SKILL.md` : boucle active d’orchestration (rester dans le tour, outils existants, polling progressif borné ; `RUNNING`/CI pending n’est pas une fin). Frontières kit/app. Renvoi court `CONTRACT.md` §10. Pas de moteur ni de transport nouveau.
