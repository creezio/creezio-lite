...
import type { Identity, Workspace } from '@creezio-lite/core';
import { fail, requireRole } from '@creezio-lite/core/validation';

export type NativeContext = { db: D1Database; user: Identity; workspace: Workspace };
